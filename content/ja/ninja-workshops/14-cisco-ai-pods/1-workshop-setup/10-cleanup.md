...
ワークショップが完了したら、このセクションの手順に従って OpenShift クラスターをアンインストールしてください。
...
AWS アカウントから Red Hat OpenShift Service を完全に削除したい場合は、[OpenShift documentation](https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws/4/html/install_clusters/rosa-hcp-deleting-cluster) を参照してください。
